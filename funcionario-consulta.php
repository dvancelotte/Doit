...
echo "<script>consulta = $funcionario ;
               ...
               $.each(consulta, function (i, item) {
                ...
                function alterarFuncionario(idfuncionario){
                    ...
                    currentLocation = currentLocation.replace('funcionario-consulta-nome.php','funcionario-altera-formulario.php?id_funcionario=');
                    currentLocation = currentLocation.replace('funcionario-cadastro.php','funcionario-altera-formulario.php?id_funcionario=');
